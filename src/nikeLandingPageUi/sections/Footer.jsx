import { copyrightSign } from "../../assets/assetsNikeLandingPageUI/icons";
import { footerLogo } from "../../assets/assetsNikeLandingPageUI/images";
    ...
    <div className="padding-x padding-t pb-8 bg-black">
      <footer className="max-container">
        <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
          <dir className="flex flex-col items-start">
            <a href="/">
